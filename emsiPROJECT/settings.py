"""
Django settings for emsiPROJECT project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'emsi.context_processors.get_departments'
            ],
        },
    },
]

WSGI_APPLICATION = 'emsiPROJECT.wsgi.application'
...
LOGIN_REDIRECT_URL = 'emsi:dashboard'
